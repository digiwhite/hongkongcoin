...
uint256 hashGenesisBlock("0x000000003d29e7f9dcc0a994d03a01456f66b38b7e765b2f9a1d511bdc7930fe");
...
const string strMessageMagic = "HongKongCoin Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uHKC
...
void ThreadScriptCheck() {
    RenameThread("hongkongcoin-scriptch");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000003d29e7f9dcc0a994d03a01456f66b38b7e765b2f9a1d511bdc7930fe");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1394121207;
        block.nBits    = 486604799;
        block.nNonce   = 2770627661;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("HongKongCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("HongKongCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static HongKongCoinMiner(CWallet *pwallet)
{
    printf("HongKongCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("hongkongcoin-miner");
    ...
    try { loop {
        ...
        printf("Running HongKongCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("HongKongCoinMiner terminated\n");
        throw;
    }
}

void GenerateHongKongCoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&HongKongCoinMiner, pwallet));
}
