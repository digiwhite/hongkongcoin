...
{
    BOOST_CHECK(TestSplitHost("www.hongkongcoin.org", "www.hongkongcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.hongkongcoin.org]", "www.hongkongcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.hongkongcoin.org:80", "www.hongkongcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.hongkongcoin.org]:80", "www.hongkongcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:11077", "127.0.0.1", 11077));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:11077", "127.0.0.1", 11077));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:11077", "::ffff:127.0.0.1", 11077));
    BOOST_CHECK(TestSplitHost("[::]:11077", "::", 11077));
    BOOST_CHECK(TestSplitHost("::11077", "::11077", -1));
    BOOST_CHECK(TestSplitHost(":11077", "", 11077));
    BOOST_CHECK(TestSplitHost("[]:11077", "", 11077));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:11077", "127.0.0.1:11077"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:11077", "[::]:11077"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
