...
#ifndef H_HONGKONGCOIN_SCRIPT
#define H_HONGKONGCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CHongKongCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, HongKongCoin always counted CHECKMULTISIGs
