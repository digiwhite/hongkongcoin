    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new HongKongCoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->hongkongcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting HongKongCoin."), QMessageBox::Ok);
