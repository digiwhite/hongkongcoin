...
unlocked to sign the HongKongCoin-Qt.app bundle.
...
allowing somebody to distribute a HongKongCoin-Qt.app or hongkongcoin-qt-setup.exe with a valid
...
that the hongkongcoin-qt.exe file inside the installer had not been tampered with.
